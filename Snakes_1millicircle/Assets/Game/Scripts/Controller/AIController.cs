...
namespace RPG.Controller
{
    ...
    public class AIController : MonoBehaviour
    {
        ...
        public void setStartingLoaction()
        {
        ...
        {
            return Mathf.Abs(Vector3.Distance(HeroClass.Instance.transform.position, transform.position));
        }
        ...
        private void InteractWithCombat()
        {
            ...
            if (DistanceToPlayer() <= chaseDistance && fighter.CanAttack(HeroClass.Instance.gameObject) || IsAttacked())
            {
        ...
        {
            var player = HeroClass.Instance;
            bool isAttacked = player.GetComponent<HeroClass>().heroHealth > 0;
            return (isAttacked);
        }
        ...
        private void AttackBehavior()
        {
            ...
            fighter.Attack(HeroClass.Instance.gameObject);
            lastKnownLocation = HeroClass.Instance.transform.position;
        }
