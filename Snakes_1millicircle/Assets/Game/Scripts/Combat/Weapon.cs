...
namespace  RPG.Combat
{
    ...
    public class Weapon : ScriptableObject
    {
        ...
        public string wpName => weaponName;
        ...
        public void SpawnNewProjectile(Transform target, Transform rightHand, Transform leftHand)
        {
            //var proj =
            Instantiate(projectile, FindTransformOfHand(rightHand, leftHand).position, Quaternion.identity);//.SetTarget(target,weaponDamage);
        }
