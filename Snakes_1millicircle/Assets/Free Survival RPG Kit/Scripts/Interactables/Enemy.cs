...
public class Enemy : Interactable {
	...
	{
		Debug.Log("Interact");
        CharacterCombat combatManager = Player23.instance.playerCombatManager;
    ...
    void Die()
    {
        ...
        Player23.instance.GetComponent<CharacterCombat>().Normal();
        Player23.instance.GetComponent<PlayerController>().focus = null;
        Player23.instance.GetComponent<CharacterCombat>().healthSlider.gameObject.SetActive(false);
