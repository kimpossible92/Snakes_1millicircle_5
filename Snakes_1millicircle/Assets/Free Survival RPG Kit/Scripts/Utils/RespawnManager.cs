...
{
    [Header("[Player23 Respawn Settings]")]
    ...
    public void DoPlayerRespawn()
    {
        ...
        Camera.main.GetComponent<CameraController23>().target = newPlayer.transform;

        // Destroy old player
        Destroy(GameObject.FindGameObjectWithTag("Player23"));
        ...
        // Log
        Debug.LogFormat("Respawn Player23 {0}", newPlayer.name);
    }
