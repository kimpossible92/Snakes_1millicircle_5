...
public class Ekard_AbilityTracker : MonoBehaviour
{
    ...
    /// AllIn1VfxAssmebly использовать ассеты воды огня и ветра для qwert
    /// </summary>
    /// 
    ...
    [SerializeField] private GameObject Q_Ability_Indicator;

    [SerializeField] private GameObject W_Ability_Range;
    [SerializeField] private bool ViewRetrn;
    [SerializeField] private Image W_Ability_Indicator_Image;
    [SerializeField] private Transform _space_target;
    [SerializeField] private GameObject MyParent;
    [SerializeField] private GameObject W_Ability_Canvas;
    #endregion
    ...
    void Start()
    {
        ...
        //Q_Ability_Indicator = abilityHUDVisual.Q_Ability_Indicator;
        //W_Ability_Range = abilityHUDVisual.W_Ability_Range;
        W_Ability_Indicator_Image = abilityHUDVisual.W_Ability_Indicator_Image;
        W_Ability_Canvas = abilityHUDVisual.W_Ability_Canvas;
        heroClass.W_Ability.HUDIcon = abilityHUDVisual.W_Ability_Indicator_Image;
        heroClass.Q_Ability.HUDIcon = abilityHUDVisual.Q_Ability_Indicator_Image;
        W_pos0 = abilityHUDVisual.W_Ability_Indicator_Image.rectTransform.anchoredPosition3D;
        Q_pos0 = abilityHUDVisual.Q_Ability_Indicator_Image.rectTransform.anchoredPosition3D;
        #region Case By Case Hero Init
        if (ViewRetrn) return;
        // Q Ability - Cube
        Q_Ability_RangeNum = heroClass.Q_Ability.abilityRangeNum;
        Q_Ability_Indicator.transform.localScale = new Vector2(Q_Ability_Indicator.transform.localScale.x, Q_Ability_RangeNum * 0.05f);

        // W Ability - Cube
        AOESkillshot_MaxAbility_Distance = heroClass.W_Ability.abilityRangeNum;
        W_Ability_Range.transform.localScale = new Vector2(AOESkillshot_MaxAbility_Distance * 0.1f, AOESkillshot_MaxAbility_Distance * 0.1f);
